...
logging.info("Starting DMG Simluator ...")
...
logging.info("Starting DMG Simluator 1...")
...
logging.info("Starting DMG Simluator 2...")
...
if (response.status_code == 200):
    ...
    logging.info("Docker Sim device exists: " + deviceId)
else:
    # Create device
